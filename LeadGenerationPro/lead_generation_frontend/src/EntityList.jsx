...
const EntityList = () => {
  ...
  const fetchEntityInfo = async (entityName) => {
    try {
      const response = await fetch(`https://trustworthy-wilburn-retroactively.ngrok-free.dev/entity/entity-info/${entityName}`);
      if (!response.ok) {
  ...
  const saveChanges = async () => {
    ...
    try {
      ...
      if (toAdd.length > 0) {
        ...
        const addResponse = await fetch(`https://trustworthy-wilburn-retroactively.ngrok-free.dev/entity/edit-entity/${editingEntity}`, {
          method: "PUT",
      ...
      for (const attr of toRemove) {
        const removeResponse = await fetch(`https://trustworthy-wilburn-retroactively.ngrok-free.dev/entity/delete-column/${editingEntity}/${attr.originalName}`, {
          method: "DELETE"
        });
      ...
      for (const attr of toRename) {
        ...
        const renameResponse = await fetch(`https://trustworthy-wilburn-retroactively.ngrok-free.dev/entity/rename-column/${editingEntity}/${attr.originalName}/${attr.name}`, {
          method: "PUT"
        });
  ...
  const deleteEntity = async (entityName) => {
    ...
    try {
      const response = await fetch(`https://trustworthy-wilburn-retroactively.ngrok-free.dev/entity/delete-entity/${entityName}`, {
        method: "DELETE"
      });
      const data = await response.json();
