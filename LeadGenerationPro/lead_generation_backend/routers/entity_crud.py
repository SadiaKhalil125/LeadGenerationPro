...
async def get_all_entities():
    ...
    try:
        ...
        cur.execute("""
            ...
            AND table_name NOT IN ('entity_mappings','sources','tasks','quick_extract_results','quick_extract_logs','task_execution_logs','chat_messages','chat_sessions','event','user','users')
            ORDER BY table_name
        """)
